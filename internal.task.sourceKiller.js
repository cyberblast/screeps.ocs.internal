...
mod.register = () => {
    ...
    Flag.found.on( flag => Task.sourceKiller.handleFlagFound(flag) );
    // a creep starts spawning
    Creep.spawningStarted.on( params => Task.sourceKiller.handleSpawningStarted(params) );
    // a creep completed spawning
    Creep.spawningCompleted.on( creep => Task.sourceKiller.handleSpawningCompleted(creep) );
    // a creep will die soon
    Creep.predictedRenewal.on( creep => Task.sourceKiller.handleCreepDied(creep.name) );
    // a creep died
    Creep.died.on( name => Task.sourceKiller.handleCreepDied(name) );
};
// for each flag
