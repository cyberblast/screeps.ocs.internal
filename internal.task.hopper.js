...
mod.register = () => {
    ...
    Flag.found.on( flag => Task.hopper.handleFlagFound(flag) );
    // a creep starts spawning
    Creep.spawningStarted.on( params => Task.hopper.handleSpawningStarted(params) );
    // a creep completed spawning
    Creep.spawningCompleted.on( creep => Task.hopper.handleSpawningCompleted(creep) );
    // a creep will die soon
    Creep.predictedRenewal.on( creep => Task.hopper.handleCreepDied(creep.name) );
    // a creep died
    Creep.died.on( name => Task.hopper.handleCreepDied(name) );
};
// for each flag
