var mod = {
    extend: function(){
        ...
        Creep.action = {
            building: require(Memory.modules.action.building), 
            charging: require(Memory.modules.action.charging),
            claiming: require(Memory.modules.action.claiming),
            defending: require(Memory.modules.action.defending),
            dismantling: require(Memory.modules.action.dismantling),
            feeding: require(Memory.modules.action.feeding), 
            fortifying: require(Memory.modules.action.fortifying), 
            fueling: require(Memory.modules.action.fueling), 
            guarding: require(Memory.modules.action.guarding), 
            harvesting: require(Memory.modules.action.harvesting),
            healing: require(Memory.modules.action.healing),
            idle: require(Memory.modules.action.idle),
            invading: require(Memory.modules.action.invading),
            picking: require(Memory.modules.action.picking), 
            repairing: require(Memory.modules.action.repairing), 
            reserving: require(Memory.modules.action.reserving),
            travelling: require(Memory.modules.action.travelling), 
            storing: require(Memory.modules.action.storing), 
            uncharging: require(Memory.modules.action.uncharging),
            upgrading: require(Memory.modules.action.upgrading), 
            withdrawing: require(Memory.modules.action.withdrawing),
            robbing:require(Memory.modules.action.robbing),
            reallocating:require(Memory.modules.action.reallocating)
        };
        Creep.behaviour = {
            claimer: require(Memory.modules.behaviour.claimer),
            hauler: require(Memory.modules.behaviour.hauler),
            healer: require(Memory.modules.behaviour.healer),
            melee: require(Memory.modules.behaviour.melee),
            miner: require(Memory.modules.behaviour.miner),
            mineralMiner: require(Memory.modules.behaviour.mineralMiner),
            pioneer: require(Memory.modules.behaviour.pioneer),
            privateer: require(Memory.modules.behaviour.privateer),
            ranger: require(Memory.modules.behaviour.ranger),
            upgrader: require(Memory.modules.behaviour.upgrader),
            warrior: require(Memory.modules.behaviour.warrior),
            worker: require(Memory.modules.behaviour.worker)
        };
        Creep.setup = {
            claimer: require(Memory.modules.setup.claimer),
            hauler: require(Memory.modules.setup.hauler),
            healer: require(Memory.modules.setup.healer), 
            melee: require(Memory.modules.setup.melee),
            miner: require(Memory.modules.setup.miner),
            mineralMiner: require(Memory.modules.setup.mineralMiner),
            pioneer: require(Memory.modules.setup.pioneer),
            privateer: require(Memory.modules.setup.privateer),
            ranger: require(Memory.modules.setup.ranger),
            upgrader: require(Memory.modules.setup.upgrader),
            warrior: require(Memory.modules.setup.warrior),
            worker: require(Memory.modules.setup.worker)
        };
        Creep.loop = function(){
